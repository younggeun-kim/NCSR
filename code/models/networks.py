...
#def define_Flow2(opt, step):
#    opt_net = opt['network_G']
#    which_model = opt_net['which_model_G2']

#    Arch = find_model_using_name(which_model)
#    netG = Arch(in_nc=opt_net['in_nc2'], out_nc=opt_net['out_nc2'],
#                nf=opt_net['nf2'], nb=opt_net['nb2'], scale=opt['scale2'], K=opt_net['flow2']['K'], opt=opt, step=step)
